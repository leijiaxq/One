...
import com.meimengmeng.one.utils.ScreenSizeUtils;
...
public class MDEditDialog implements View.OnClickListener, DialogInterface.OnDismissListener {
    ...
    public MDEditDialog(Builder builder) {
        ...
        mDialogView = View.inflate(mContext, R.layout.dialog_change, null);
    ...
    public static class Builder {
        ...
        public Builder(Context context) {
            ...
            mContext = context;
            titleText = "提示";
            titleTextColor = ContextCompat.getColor(mContext, R.color.text_black);
            contentText = "";
            contentTextColor = ContextCompat.getColor(mContext, R.color.text_black);
            leftButtonText = "取消";
            leftButtonTextColor = ContextCompat.getColor(mContext, R.color.text_black);
            rightButtonText = "确定";
            rightButtonTextColor = ContextCompat.getColor(mContext, R.color.text_black);
            lineColor = ContextCompat.getColor(mContext, R.color.text_black);
            listener = null;
            isTitleVisible = true;
            isTouchOutside = true;
            hintText = "";
            hintTextColor = ContextCompat.getColor(mContext, R.color.line_gray);
            lines = -1;
            maxLines = -1;
            maxLength = -1;
            height = 0.28f;
    ...
    public EditText getEditTextInstant() {
        return mEdit;
    }
